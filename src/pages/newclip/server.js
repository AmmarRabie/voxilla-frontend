...
export const synthesizeText = (oldWord, newWord) => {
    return axios.post("http://localhost:5000/insert", { text: newWord }, { headers: { "Cache-Control": "no-store,no-cache" } }).then(res => `http://localhost:5000/download/${res.data.fname}`)
}
